...
//        craftWorld0_0001_header_1.getDriver().manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
//        if (firstTime) {
//            craftWorld0_0001_header_1.setItem("CraftBet-user", user);
//            craftWorld0_0001_header_1.setItem("token", token);
//            logger.info("UserName and token was passed");
//            craftWorld0_0001_header_1.navigateRefresh();
//            logger.info("Page refreshed");
//        } else {
//
//            craftWorld0_0001_header_1.headerPanel1BottomLinks();
...
//                        craftWorld0_0001_header_1.clickOnHeader1LoginButton();
//                    }
...
//            if (craftWorld0_0001_header_1.balanceIsVisible()) {
//                user = craftWorld0_0001_header_1.getItem("CraftBet-user");
//                token = craftWorld0_0001_header_1.getItem("token");
//                firstTime = true;
//            }
//        }
//        craftWorld0_0001_header_1.waitAction(waitTime);
//    }
//
//
//
...
//        craftWorld0_0001_header_1.headerPanel2BottomLinks();
//
