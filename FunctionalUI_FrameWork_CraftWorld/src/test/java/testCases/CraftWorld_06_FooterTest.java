...
public class CraftWorld_06_FooterTest extends BaseTest{
    ...
    public void footerLEGALLinkClickFunctionalityTest() {
        ...
        craftWorld_02_footer_page.clickOnLegalLinkIfVisible();
        logger.info("From footer LEGAL link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/info/legal");
    ...
    public void footerTERMSANDCONDITIONSLinkClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnTermsConditionsLinkIfVisible();
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        logger.info("From footer TERMS AND CONDITIONS link was clicked");
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/info/terms");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerRESPONSIBLEGAMINGLinkClickFunctionalityTest1() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnResponseGamingLinkIfVisible();
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        logger.info("From footer ResponsibleGame link was clicked");
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/info/faq");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerSELFEXCLUSIONLinkClickFunctionalityTest1() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnSelfExclusionLinkIfVisible();
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        logger.info("From footer SELF EXCLUSION link was clicked");
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/info/self");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerDISPUTERESOLUTIONLinkClickFunctionalityTest1() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnResolutionLinkIfVisible();
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        logger.info("From footer DISPUTE RESOLUTION link was clicked");
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/info/dispute");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerAMLinkClickFunctionalityTest1() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnLegalAMLLinkIfVisible();
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        logger.info("From footer AML link was clicked");
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/info/aml");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerFAIRGAMINGANDRNGLinkClickFunctionalityTest1() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnFairGamingAMGLinkIfVisible();
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        logger.info("From footer FAIR GAMING AND RNG link was clicked");
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/info/fairgaming");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerPRIVACYPOLICYLinkClickFunctionalityTest1() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnPrivacyPolicyLinkIfVisible();
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        logger.info("From footer PRIVACY POLICY link was clicked");
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/info/privacy");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerACCOUNTPAYOUTSBONUSESLinkClickFunctionalityTest1() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnAccountPayOutsBonusesLinkIfVisible();
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        logger.info("From footer ACCOUNT, PAYOUTS, BONUSES link was clicked");
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/info/aboutus");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerKYCPOLICIESLinkClickFunctionalityTest1() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnKYSPoliciesLinkLinkIfVisible();
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        logger.info("From footer KYC POLICIES link was clicked");
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/info/kyc");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerSPORTSBOOKClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnSportsBookLinkIfVisible();
        logger.info("From footer SPORTSBOOK link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/info/sportsbook");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerPREMIERLEAGUEClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnPremierLinkIfVisible();
        logger.info("From footer PREMIER LEAGUE link was clicked");
        craftWorld_02_footer_page.handleWindowsWithArrayList(1);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/sport/prematch#/prematch/competitions?sport=1&competitions=10186");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerLIGUE1ClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnLigueOneLinkIfVisible();
        logger.info("From footer LIGUE 1 link was clicked");
        craftWorld_02_footer_page.handleWindowsWithArrayList(1);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/sport/prematch#/prematch/competitions?sport=1&competitions=9312");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerBUNDESLIGAClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnBundesligaLinkIfVisible();
        logger.info("From footer BUNDESLIGA link was clicked");
        craftWorld_02_footer_page.handleWindowsWithArrayList(1);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/sport/prematch#/prematch/competitions?sport=1&competitions=15577");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerSERIEAClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnSerieALinkIfVisible();
        logger.info("From footer SERIE A link was clicked");
        craftWorld_02_footer_page.handleWindowsWithArrayList(1);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/sport/prematch#/prematch/competitions?sport=1&competitions=11270");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerCHAMPIONSLEAGUEClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnChampionsLinkIfVisible();
        logger.info("From footer CHAMPIONS LEAGUE link was clicked");
        craftWorld_02_footer_page.handleWindowsWithArrayList(1);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/sport/prematch#/prematch/competitions?sport=1&competitions=10055");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerCASINOLIVECASINOClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnCasinoLifeCasinoLinkIfVisible();
        logger.info("From footer CASINO & LIVE CASINO link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/info/casinoandlivecasino");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerEVOLUTIONClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnEvolutionLinkIfVisible();
        logger.info("From footer EVOLUTION link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/products/5/21000/real");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerEZUGIClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnEzugiLinkIfVisible();
        logger.info("From footer EZUGI link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/products/5/5001/real");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerTOMHORNClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnCasinoTomHornLinkIfVisible();
        logger.info("From footer TOM HORN link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertNotEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/home");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerZEYSPLAYClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnCasinoZeysLinkLinkIfVisible();
    ...
    public void footerVirtualGamesClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnVirtualGamesLinkIfVisible();
        logger.info("From footer Virtual Games link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/info/virtualgames");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerBINGO37ClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnBingo37LinkIfVisible();
        logger.info("From footer BINGO 37 link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/category/5/1001/real/1");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerKENOClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnKenoLinkIfVisible();
        logger.info("From footer KENO link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/category/5/1004/real/1");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerCRASHClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnCrashLinkIfVisible();
        logger.info("From footer CRASH link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/category/5/1008/real/1");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerHIGHLOWClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnHighLowLinkIfVisible();
        logger.info("From footer HIGH LOW link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/category/5/1007/real/1");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerBETONRACINGClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnBetOnRacingLinkIfVisible();
        logger.info("From footer BET ON RACING link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/category/5/1006/real/1");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerBETONPOKERClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnBetOnPokerLinkIfVisible();
        logger.info("From footer BET ON POKER link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/category/5/1005/real/1");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerBINGO47ClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnBingo47LinkIfVisible();
        logger.info("From footer BINGO 47 link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/category/5/1003/real/1");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerCOLORSClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnColorsLinkIfVisible();
        logger.info("From footer COLORS link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/category/5/1002/real/1");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
    ...
    public void footerMINESWEEPERClickFunctionalityTest() {
        SoftAssert softAssert = new SoftAssert();
        craftWorld_02_footer_page.clickOnMinesweeperLinkIfVisible();
        logger.info("From footer MINESWEEPER link was clicked");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
        softAssert.assertEquals(craftWorld_02_footer_page.getUrl(), "https://craftbet.com/category/5/1010/real/1");
        logger.info("URL was checked: "+ craftBet_01_header_pageLogInUser.getUrl());
        craftBet_01_header_pageLogInUser.navigateRefresh();
        logger.info("Page was refreshed");
        craftBet_01_header_pageLogInUser.waitAction(waitTime);
