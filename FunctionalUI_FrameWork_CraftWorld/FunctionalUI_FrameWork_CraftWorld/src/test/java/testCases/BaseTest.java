...
public class BaseTest extends DriverFactory {
    ...
    public CraftBet_01_Header_Page_LogInUser craftBet_01_header_pageLogInUser;
    public CraftBet_01_Header_Page_LogOutUser craftBet_01_header_page_logOutUser;
    ...
    public void setup() throws  UnirestException, IOException {
        ...
        craftBet_01_header_pageLogInUser = PageFactory.initElements(this.driver, CraftBet_01_Header_Page_LogInUser.class);
        craftBet_01_header_page_logOutUser = PageFactory.initElements(this.driver, CraftBet_01_Header_Page_LogOutUser.class);
