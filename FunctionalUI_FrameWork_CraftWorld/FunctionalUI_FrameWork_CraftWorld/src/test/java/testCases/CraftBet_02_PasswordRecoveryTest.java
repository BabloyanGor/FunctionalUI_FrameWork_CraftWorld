...
public class CraftBet_02_PasswordRecoveryTest extends BaseTest{


    public CraftBet_02_PasswordRecoveryTest() throws AWTException {
    }
    ...
    public void RecoveryPopUpLabelsPresenceVerification_Test() {
        ...
        String actTitle = craftBet_04_passwordRecovery_page.getTitleText();
        logger.info("Title Captured");
        String actEmailInputLabel = craftBet_04_passwordRecovery_page.getEmailInputsLabel();
        logger.info("Emails label Captured");
        String actFormLabelInfo = craftBet_04_passwordRecovery_page.getFormLabelInfo();
        logger.info("Info message Captured");
        String actHelpMessageLabel = craftBet_04_passwordRecovery_page.getHelpMessageLabel();
        logger.info("Help message Captured");
        String actTextOnSendMeRecoveryButton = craftBet_04_passwordRecovery_page.getTextOnSendMeRecoveryButton();
    ...
    public void RecoveryPopUpLogoPresenceVerification_Test() {
        Assert.assertEquals(craftBet_04_passwordRecovery_page.logoExistenceVerification(), true);
    ...
    public void RecoveryPopUpSupportLink_Test() {
        String RecoveryUrl = craftBet_04_passwordRecovery_page.getUrl();
        logger.info("Password recovery page url captured");
        craftBet_04_passwordRecovery_page.clickOnSupportLink();
        logger.info("Password recovery page support link clicked");
        String supportUrl = craftBet_04_passwordRecovery_page.getUrl();
    ...
    public void RecoveryPopUpPositiveTest() {
        craftBet_04_passwordRecovery_page.sendKeysToEmailPhoneInput("g.babloyan@iqsoft.am");
        logger.info("email passed");
        craftBet_04_passwordRecovery_page.clickOnSendMeRecoveryButton();
        logger.info("Send me password Recovery Button was clicked");
        String actSuccessMessage = craftBet_04_passwordRecovery_page.getSuccessMessage();
    ...
    public void RecoveryPopUpNegativeTest(String data) {
        ...
        craftBet_04_passwordRecovery_page.sendKeysToEmailPhoneInput(data);
        logger.info("password recovery input passed: --->" + data + "<---");
        craftBet_04_passwordRecovery_page.clickOnSendMeRecoveryButton();
        logger.info("Send me password Recovery Button was clicked");


        if ( craftBet_04_passwordRecovery_page.getErrorMessage().equals("Wrong recovery input") ) {
//            logger.info("Success message: --->" + craftBet_04_passwordRecovery_page.getMailSuccessMessage() + "<---");
//            logger.info("Error message: --->" + craftBet_04_passwordRecovery_page.getErrorMessage() + "<---");
