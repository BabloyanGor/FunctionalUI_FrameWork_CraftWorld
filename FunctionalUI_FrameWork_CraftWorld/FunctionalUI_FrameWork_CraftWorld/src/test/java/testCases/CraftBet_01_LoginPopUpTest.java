...
CraftBet_01_LoginPopUpTest extends BaseTest {
    int wait = 1000;

    public CraftBet_01_LoginPopUpTest() throws AWTException {
    }
    ...
    public void loginPopUpLabelsPresenceVerification_Test() {
        ...
        String actHeader = craftBet_03_login_popUp_page.getLoginPopUpHeader();
        logger.info("Header Captured:  " + craftBet_03_login_popUp_page.getLoginPopUpHeader());

        String actualEmailLabel = craftBet_03_login_popUp_page.getLoginPopUpEmailOrUsernameLabel();
        logger.info("Username label captured:  " +  craftBet_03_login_popUp_page.getLoginPopUpEmailOrUsernameLabel());

        String actualPasswordLabel = craftBet_03_login_popUp_page.getLoginPopUpPasswordLabel();
        logger.info("Password label captured:  " + craftBet_03_login_popUp_page.getLoginPopUpPasswordLabel());

        String actualRememberMyLabel = craftBet_03_login_popUp_page.loginPopUpRememberMeLabelGetText();
        logger.info("Remember me label Captured:  " +  craftBet_03_login_popUp_page.loginPopUpRememberMeLabelGetText());

        String actualYouCanSignUpWithLabel = craftBet_03_login_popUp_page.loginPopUpYouCanSignUpWithLabelGetText();
        logger.info("You can Sign in with label Captured:  " + craftBet_03_login_popUp_page.loginPopUpYouCanSignUpWithLabelGetText());

        String actualDontHaveAnAccountLabel = craftBet_03_login_popUp_page.loginPopUpDoNotHaveAccountLabelGetText();
        logger.info("Don't have an account? label Captured:  ");

        String actualSaveAndSecureLabel = craftBet_03_login_popUp_page.loginPopUpSaveAndSecureLabelGetText();
        logger.info("Safe and secure label Captured:  " +  craftBet_03_login_popUp_page.loginPopUpDoNotHaveAccountLabelGetText());

        craftBet_03_login_popUp_page.loginPopUpEmailOrUsernameSendKeys("g.babloyan@iqsoft.am");
        logger.info("Username passed");

        craftBet_03_login_popUp_page.loginPopUpPasswordSendKeys("12345678");
        logger.info("Password passed");

        String actualLoginButtonText = craftBet_03_login_popUp_page.loginPopUpLoginButtonGetText();
    ...
    public void loginPopUpCloseButtonFunctionality_Test() {
        craftBet_03_login_popUp_page.clickOnLoginPopUpCloseButton();
        logger.info("close (X) button was clicked");
        Assert.assertEquals(craftBet_03_login_popUp_page.loginPopUpLogoPresence(), false);
    ...
    public void loginPopUpEyeButtonFunctionality_Test() {
        SoftAssert softAssert = new SoftAssert();
        craftBet_03_login_popUp_page.loginPopUpPasswordSendKeys("123456");
        logger.info("password passed");
        craftBet_03_login_popUp_page.clickLoginPopUpEyeShowPassword();
        logger.info("Eye icon clicked");
        String typeText = craftBet_03_login_popUp_page.getPasswordInputTypeAttribute();
        softAssert.assertEquals(typeText, "text");
        logger.info("Passwords visibility was checked");
        craftBet_03_login_popUp_page.clickLoginPopUpEyeShowPassword();
        logger.info("Eye icon click again");
        String typePassword = craftBet_03_login_popUp_page.getPasswordInputTypeAttribute();
    ...
    public void loginPopUpRememberMeLabelClickAbility_Test() {
        SoftAssert softAssert = new SoftAssert();
        craftBet_03_login_popUp_page.clickLoginPopUpRememberMeLabel();
        logger.info("Remember me label clicked");
        softAssert.assertEquals(craftBet_03_login_popUp_page.loginPopUpRememberMeCheckboxIsSelected(), true);
        craftBet_03_login_popUp_page.clickLoginPopUpRememberMeLabel();
        logger.info("Remember me label clicked again");
        softAssert.assertEquals(craftBet_03_login_popUp_page.loginPopUpRememberMeCheckboxIsSelected(), false);
        softAssert.assertAll();
    }
    ...
    public void loginPopUpCheckBoxClickAbility_Test() {
        SoftAssert softAssert = new SoftAssert();
        craftBet_03_login_popUp_page.clickLoginPopUpRememberMeCheckbox();
    ...
    public void loginPopUpForgotPasswordLink_Test() {
        craftBet_03_login_popUp_page.clickLoginPopUpForgotPassword();
        logger.info("ForgotPassword link clicked");
        String url = craftBet_03_login_popUp_page.getUrl();
    ...
    public void loginPopUpSignUpLink_Test() {
        craftBet_03_login_popUp_page.clickLoginPopUpSignUpLink();
        logger.info("SignUp link clicked");
        try {
            craftBet_05_signUp_popUp_page.getTitleQ();
    ...
    public void loginPopUpLogInNegativeTest(String dataUsername, String dataPassword) {
        ...
        craftBet_03_login_popUp_page.loginPopUpEmailOrUsernameSendKeys(dataUsername);
        logger.info("username passed -->" + dataUsername + "<--");
        craftBet_03_login_popUp_page.loginPopUpPasswordSendKeys(dataPassword);
        ...
        if (craftBet_03_login_popUp_page.loginPopUpErrorMessageGetText().equals("There is no loginPopUpErrorMessage element")){
            craftBet_03_login_popUp_page.waitAction(500);
            Assert.assertTrue(false, "There is no loginPopUpErrorMessage element");
        }
        else{
            logger.info("Error message is: --> " + craftBet_03_login_popUp_page.loginPopUpErrorMessageGetText());
            Assert.assertTrue(true, craftBet_03_login_popUp_page.loginPopUpErrorMessageGetText());
        }
    }
...
//    }
    ...
    public void loginPopUpErrorMessageValidationInvalidUsername() throws InterruptedException {
        craftBet_03_login_popUp_page.loginPopUpEmailOrUsernameSendKeys(username);
        logger.info("username passed");
        craftBet_03_login_popUp_page.loginPopUpPasswordSendKeys("1234");
        logger.info("password passed");
        craftBet_03_login_popUp_page.clickLoginPopUpLogInButton();
        logger.info("log in button was clicked");
        craftBet_03_login_popUp_page.waitAction(wait);
        Assert.assertEquals(craftBet_03_login_popUp_page.loginPopUpErrorMessageGetText(), "Username or Password is incorrect. Please try again.");
    }
    ...
    public void loginPopUpErrorMessageValidationInvalidPassword() throws InterruptedException {
        craftBet_03_login_popUp_page.loginPopUpEmailOrUsernameSendKeys("1234");
        logger.info("username passed");
        craftBet_03_login_popUp_page.loginPopUpPasswordSendKeys(password);
        logger.info("password passed");
        craftBet_03_login_popUp_page.clickLoginPopUpLogInButton();
