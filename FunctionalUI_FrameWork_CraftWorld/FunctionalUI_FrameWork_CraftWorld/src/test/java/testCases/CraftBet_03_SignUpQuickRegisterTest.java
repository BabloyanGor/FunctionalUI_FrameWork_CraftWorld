...
public class CraftBet_03_SignUpQuickRegisterTest extends BaseTest {


    public CraftBet_03_SignUpQuickRegisterTest() throws AWTException {
    }

    @BeforeMethod
    public void goToLoginPopUp() {
        craftBet_01_header_page_logOutUser.clickOnSignUp();
        craftBet_05_signUp_popUp_page.clickOnButtonQuickRegistration();
    }
    ...
    public void SignUpPopUpQuickRegisterLabelsPresenceVerification_Test() {
        ...
        String actTitle = craftBet_05_signUp_popUp_page.getTitleQ();
        logger.info("Title Captured: --->" + actTitle);
        String expectedTitle = "Quick Register";
        logger.info("Title expected: --->" + expectedTitle);
        String actEmailDropDownLabel = craftBet_05_signUp_popUp_page.getTextLabelEmailMobileDropDownQ();
        ...
        String actEmailInputLabel = craftBet_05_signUp_popUp_page.getTextLabelEmailInputQ();
        ...
        String actCurrencyLabel = craftBet_05_signUp_popUp_page.getTextLabelCurrencyDropDownQ();
        ...
        String actTermsLabel = craftBet_05_signUp_popUp_page.getTextLabelTermsConditionsQ();
        ...
        String actRegisterButtonText = craftBet_05_signUp_popUp_page.getTextButtonRegisterQ();
        ...
        String actAlreadyHaveAccount = craftBet_05_signUp_popUp_page.getTextLabelAlreadyHaveAnAccount();
        ...
        String actPleaseFillLabel = craftBet_05_signUp_popUp_page.getTextLabelPleaseFill();
...
//        logger.info("Please fill expected label: --->" + expectedSwitchButtonLabel);
        String actThisSiteProtected = craftBet_05_signUp_popUp_page.getTextLabelThisSiteProtected();
        ...
        String actSafeAndSecureLabel = craftBet_05_signUp_popUp_page.getTextLabelSafeAndSecure();
...
//        logger.info("SwitchButtonLabel label checked");
    ...
    public void SignUpPopUpQuickRegisterLogoPresenceVerification_Test() {
        SoftAssert softAssert = new SoftAssert();
        softAssert.assertEquals(craftBet_05_signUp_popUp_page.BackgroundPhotoPresence(), true);
        logger.info("Background photo existence checked");
        softAssert.assertEquals(craftBet_05_signUp_popUp_page.logoPresence(), true);
    ...
    public void SignUpPopUpQuickRegisterRegisterByDropDownVerification_Test() {
        SoftAssert softAssert = new SoftAssert();
        craftBet_05_signUp_popUp_page.selectEmailMobileDropDownQ("Email");
        logger.info("From Email/Mobile DropDown select Email");
        softAssert.assertEquals(craftBet_05_signUp_popUp_page.getTextLabelEmailInputQ(), "Email");
        logger.info("From Email Input get text");
        craftBet_05_signUp_popUp_page.selectEmailMobileDropDownQ("Mobile");
        logger.info("From Email/Mobile DropDown select Mobile");
        softAssert.assertEquals(craftBet_05_signUp_popUp_page.getTextLabelMobileInputQ(), "Mobile");
    ...
    public void SignUpPopUpQuickRegisterCurrencyDropDownVerification_Test() {
        SoftAssert softAssert = new SoftAssert();
        craftBet_05_signUp_popUp_page.selectFromCurrencyDropDownByVisibleTextQ("AMD");
        logger.info("From Currency DropDown select AMD");
        softAssert.assertEquals(craftBet_05_signUp_popUp_page.getTextFromCurrencyDropDownQ(), "AMD");
        logger.info("From Currency DropDown getting text");
        craftBet_05_signUp_popUp_page.selectFromCurrencyDropDownByVisibleTextQ("EUR");
        logger.info("From Currency DropDown select EUR");
        softAssert.assertEquals(craftBet_05_signUp_popUp_page.getTextFromCurrencyDropDownQ(), "EUR");
        logger.info("From Currency DropDown getting text");
        craftBet_05_signUp_popUp_page.selectFromCurrencyDropDownByVisibleTextQ("USD");
        logger.info("From Currency DropDown select USD");
        softAssert.assertEquals(craftBet_05_signUp_popUp_page.getTextFromCurrencyDropDownQ(), "USD");
        logger.info("From Currency DropDown getting text");
        softAssert.assertAll();
    }
    ...
    public void SignUpPopUpQuickRegisterRegisterPrivacyPolicy() {
        ...
        craftBet_05_signUp_popUp_page.sendKeysEmailInputQ(craftBet_05_signUp_popUp_page.generateRandomEmailValid());
        logger.info("valid email was generated and passed ");
        softAssert.assertEquals(craftBet_05_signUp_popUp_page.getAttributeClassButtonRegisterQ(), "craft_btn reg_btn active-item not_active");
        logger.info("Register button activity checked without clicking on TermsAndConditions checkbox ");
        craftBet_05_signUp_popUp_page.clickOnCheckBoxTermsConditionsQ();
        logger.info("Terms and conditions checkbox was selected");
        softAssert.assertEquals(craftBet_05_signUp_popUp_page.getAttributeClassButtonRegisterQ(), "craft_btn reg_btn active-item");
    ...
    public void SignUpPopUpCloseButtonFunctionality() {
        craftBet_05_signUp_popUp_page.clickOnButtonCloseXButton();
        logger.info("Close (X) button was clicked");
        Assert.assertEquals(craftBet_05_signUp_popUp_page.logoPresence(), false);
    }
    ...
    public void SignUpPopUpTermsAndConditionsLinkFunctionality() {
        craftBet_05_signUp_popUp_page.clickOnLinkTermsConditionsQ();
        logger.info("Terms and conditions link was clicked");
        Assert.assertEquals(craftBet_05_signUp_popUp_page.getUrl(), "https://craftbet.com/terms");
    }
    ...
    public void SignUpPopUpLogInLinkFunctionality() {
        craftBet_05_signUp_popUp_page.clickOnLinkLogIn();
        logger.info("LogIn  link was clicked");
        Assert.assertEquals(craftBet_03_login_popUp_page.loginPopUpLogoPresence(), true);
    }
    ...
    public void SignUpPopUpQuickFullRegistrationButtonFunctionality() throws InterruptedException {
        SoftAssert softAssert = new SoftAssert();
        softAssert.assertEquals(craftBet_05_signUp_popUp_page.getTitleQ(), "Quick Register");
        ...
        softAssert.assertEquals(craftBet_05_signUp_popUp_page.getTextLabelFirstName(), "First name");
    ...
    public void SignUpPopUpQuickRegisterWithEmailPositiveTest() {
        ...
        craftBet_05_signUp_popUp_page.clickOnCheckBoxTermsConditionsQ();
        logger.info("Terms and Conditions checkbox was selected");
        craftBet_05_signUp_popUp_page.clickOnButtonRegisterQ();
    ...
    public void SignUpPopUpQuickRegisterWithEmailNegativeTest(String invalidEmail) {
        ...
        craftBet_05_signUp_popUp_page.sendKeysEmailInputQ(invalidEmail);
        logger.info("invalid Email sent: -->" + invalidEmail);
        craftBet_05_signUp_popUp_page.clickOnCheckBoxTermsConditionsQ();
        logger.info("Terms and conditions checkbox clicked");
        craftBet_05_signUp_popUp_page.clickOnButtonRegisterQ();
        logger.info("Register button clicked");
        String errorMessage = craftBet_05_signUp_popUp_page.getTextErrorMessage();
...
//        craftBet_05_signUp_popUp_page.clickOnMobileDropDownQ();
//        craftBet_05_signUp_popUp_page.clickOnMobileArmQ();
//        logger.info("Am+374 was selected From Email/Mobile DropDown ");
        craftBet_05_signUp_popUp_page.sendKeysMobileInputQ(craftBet_05_signUp_popUp_page.generateRandomMobileNumberValid());
...
//        craftBet_05_signUp_popUp_page.clickOnMobileArmQ();
//        logger.info("Am+374 was selected From Email/Mobile DropDown ");
        craftBet_05_signUp_popUp_page.sendKeysMobileInputQ(number);
        logger.info("InValid number was created and passed -->" + number + "<--");
        craftBet_05_signUp_popUp_page.clickOnCheckBoxTermsConditionsQ();
        logger.info("Terms and Conditions checkbox was selected");
        craftBet_05_signUp_popUp_page.waitAction(1000);
        Assert.assertEquals(craftBet_05_signUp_popUp_page.getAttributeClassButtonRegisterQ(), "craft_btn reg_btn not_active");
